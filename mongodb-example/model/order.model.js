...
async function getOrder() {
    // SELECT Orders.OrderID, Products.title, Orders.OrderDate
    // FROM Orders
    // JOIN Products ON Orders.id=Products.id;

    const result = await Orders.aggregate([
        { $match: { orderNr: 'AB1684758805553Y' } }, // Letar upp en specifik order baserat på orderNr
        ...
        { $lookup:
            {
                ...
                foreignField: 'id', // Fält i products att matcha mot i orders collection
